...
def bestFit(model, paramGrid, X_train, y_train, X_val, y_val, metric=roc_auc_score, greater_is_better=True, predict_proba=True, showPlot=True, scoreLabel=None, vrange=None, n_jobs=-1, verbose=10):
    """
    ...
    return getBestModel(models, scores, greater_is_better), getBestScore(models, scores, greater_is_better), models, scores
